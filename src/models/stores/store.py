...
class Store(object):
    ...
    def get_by_url(cls, url):
        """
        Return a store from a url like 'http://www.johnlewis.com/item/dfsfs.html'
        :param url: The item's URL
        :return: a Store, or raises a StoreNotFoundException if no store matched the URL
        """
    ...
    @classmethod
    def get_all(cls):
        # Empty dictionary means everything]
